...
$wa_url      = function_exists( 'vip_transits_vehicle_whatsapp_url' ) ? vip_transits_vehicle_whatsapp_url( $data['id'] ) : '';
...
>
	...
	<div class="vip-fleet-card__body">
		...
		<div class="vip-fleet-card__actions">
			<?php if ( $wa_url ) : ?>
			<a class="vip-fleet-card__book" href="<?php echo esc_url( $wa_url ); ?>" target="_blank" rel="noopener noreferrer">
				<?php esc_html_e( 'BOOK NOW', 'tenku-child' ); ?>
			</a>
			<a class="vip-fleet-card__icon vip-fleet-card__icon--wa" href="<?php echo esc_url( $wa_url ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e( 'WhatsApp', 'tenku-child' ); ?>">
