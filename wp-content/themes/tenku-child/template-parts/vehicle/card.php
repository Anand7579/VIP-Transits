...
<article
	...
	data-vehicle-id="<?php echo esc_attr( (string) $data['id'] ); ?>"
...
>
	<?php if ( $data['thumbnail'] ) : ?>
		<a class="vip-fleet-card__media" href="<?php echo esc_url( $data['permalink'] ); ?>"<?php echo $link_target; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
			<img
	...
	<div class="vip-fleet-card__body">
		<div class="vip-fleet-card__head">
			<h3 class="vip-fleet-card__title">
				<a href="<?php echo esc_url( $data['permalink'] ); ?>"<?php echo $link_target; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php echo esc_html( $data['title'] ); ?></a>
			</h3>
		...
		<div class="vip-fleet-card__actions">
			<?php if ( $wa_href_attr ) : ?>
			<a class="vip-fleet-card__book" href="<?php echo $wa_href_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- pre-escaped attr. ?>"<?php echo $link_target; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
				<?php esc_html_e( 'BOOK NOW', 'tenku-child' ); ?>
			</a>
			<div class="whatsapp-phone">
				<a class="vip-fleet-card__icon vip-fleet-card__icon--wa" href="<?php echo $wa_href_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"<?php echo $link_target; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> aria-label="<?php esc_attr_e( 'WhatsApp', 'tenku-child' ); ?>">
